...
$(document).ready(function() {
	...
	var zNodes = [
		//
		{ id:1, pId:0, name:"个人中心首页", open:true},
		...
		{ id:11, pId:10, name:"求租订单"},
		{ id:12, pId:10, name:"出租订单"},
		{ id:13, pId:9, name:"求租管理"},
		{ id:14, pId:13, name:"已发布求租"},
		{ id:15, pId:13, name:"求租发布"},
		{ id:16, pId:9, name:"出租管理"},
		//
		...
		{ id:22, pId:21, name:"已发布出租"},
		{ id:23, pId:21, name:"出租发布"},
		...
		{ id:28, pId:27, name:"求租订单"},
		{ id:29, pId:27, name:"出租订单"},
